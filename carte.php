   ...
   <div class="card mb-3">
      <div class="row g-2">
         <div class="col-md-6">
            <br>
            <br>
            <img src="<?php echo get_template_directory_uri(); ?>/assets/fond_card2.jpg" class="img-fluid d-flex align-content-between" alt="pizza" width='580px' height="100%">
         </div>
         <div class="col-md-6">
            <div class="card-body">
...
<div class="container">
   <div class="card mb-3">
      <div class="row g-2">
         <div class="col-md-6">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/pasta-5.jpg" class="img-fluid" alt="pates"width='580px' height='710px'>
         </div>
         <div class="col-md-6">
            <div class="card-body">
...
<div class="container">
   <div class="card1 mb-3">
      <div class="row g-2">
         <div class="col-md-6">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/framb.jpg" class="img-fluid d-flex align-content-between" alt="pizza">
         </div>
         <div class="col-md-6">
            <div class="card-body">
